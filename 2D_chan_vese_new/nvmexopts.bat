...
set PATH=C:\CUDA\v4.2\bin\;%VCINSTALLDIR%\BIN\;C:\Program Files\Microsoft SDKs\Windows\v6.0A\Bin\x64;%VSINSTALLDIR%\Common7\IDE;%VSINSTALLDIR%\SDK\v2.0\bin;%VSINSTALLDIR%\Common7\Tools;%VSINSTALLDIR%\Common7\Tools\bin;%VCINSTALLDIR%\VCPackages;%MATLAB_BIN%;%PATH%
set INCLUDE=C:\CUDA\v4.2\include;%VCINSTALLDIR%\ATLMFC\INCLUDE;%VCINSTALLDIR%\INCLUDE;C:\Program Files\Microsoft SDKs\Windows\v6.0A\Include;%VSINSTALLDIR%\SDK\v2.0\include;%INCLUDE%
set LIB=C:\CUDA\v4.2\lib\x64;%VCINSTALLDIR%\ATLMFC\LIB;C:\Program Files\Microsoft SDKs\Windows\v6.0A\lib\x64;%MATLAB%\extern\lib\win64;%MATLAB%\extern\lib\win64\microsoft;%LIB%;%VCINSTALLDIR%\LIB\amd64
...
rem ********************************************************************
set LIBLOC=C:\Program Files\MATLAB\R2011a\extern\lib\win64\microsoft
set LINKER=link
